...
The QMK source tree you use must have the Community Modules feature, because the Conncurrent Macros module utilizes it.  To install the module, run this command:
